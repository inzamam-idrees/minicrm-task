jQuery(function($) {
    ...
    function updateServiceButton($holder) {
        ...
        if (service_checked == 0) {
            $holder.find('.quickad-js-count').text('No Category Selected');
            ...
            if( service_checked == $holder.find('.quickad-js-check-sub-entity').length) {
                ...
                $holder.find('.quickad-js-count').text('All Category');
            }
            else {
                $holder.find('.quickad-check-all-entities').prop('checked', false);
    ...
    $(document).on('click', '.quickad-check-all-entities, .categoryAllLabel', function (e) {
        ...
        if ($(this).hasClass("categoryAllLabel")) {
          e.preventDefault();
          if($(this).prev('input').prop('checked') == true) {
            $(this).prev('input').prop('checked', false);
            $holder.find('.quickad-js-check-entity').prop('checked', false);
            $holder.find('.quickad-js-check-sub-entity').prop('checked', false);
          } else {
            $(this).prev('input').prop('checked', true);
            $holder.find('.quickad-js-check-entity').prop('checked', true);
            $holder.find('.quickad-js-check-sub-entity').prop('checked', true);
          }
        }
    ...
    $(document).on('click', '.quickad-js-check-entity, .categoryParLabel', function (e) {

        if ($(this).hasClass("categoryParLabel")) {
          e.preventDefault();
          if($(this).prev('input').prop('checked') == true) {
            $(this).prev('input').prop('checked', false);
            $(this).closest('li').find('.quickad-js-check-sub-entity').prop('checked', false);
          } else {
            $(this).prev('input').prop('checked', true);
            $(this).closest('li').find('.quickad-js-check-sub-entity').prop('checked', true);
          }
    ...
    $(document).on('click', '.quickad-js-check-sub-entity, .categoryChiLabel', function (e) {

        if ($(this).hasClass("categoryChiLabel")) {
          e.preventDefault();
          if($(this).prev('input').prop('checked') == true) {
            $(this).prev('input').prop('checked', false);
          } else {
